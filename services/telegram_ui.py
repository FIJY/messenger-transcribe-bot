...
class TelegramUI:
    ...
    def get_help_message(self, add_to_group_url: str) -> str:
        ...
        help_text = (
            ...
            "`/summary` - Get a summary of your recent notes.\n"
            ...
            f"💎 **Premium (${premium_plan['price_usd']}/month):** An extended package of {premium_plan['limit_minutes']} minutes.\n\n"
    ...
    def get_note_created_message(self, note_text: str, note_id: ObjectId) -> tuple[str, InlineKeyboardMarkup]:
        """Формирует сообщение о создании заметки и кнопки действий."""
